...
interface Connector <K> where K: Comparable<K>, K: Serializable {
     ...
     *  - The target table name must be: "[tableName]_[aggrFunName]_[kpName]".
     ...
     *
     * @param y1 the minimum key in the range.
     * @param y2 the maximum key in the range.
     * @return the list of retrieved nodes.
     */
    fun getGroupByL(y1: Any, y2: Any): List<NodeTransfer>
     ...
     * @return the list of retrieved nodes.
     */
    fun getGroupByR(y1: Any, y2: Any): List<NodeTransfer>
     ...
     */
    fun getGroupByNBar(y1: Any, y2: Any): Map<*, NodeTransfer>
